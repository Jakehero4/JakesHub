...
local TeleportSpawnButton = TeleportTab:CreateButton({
   ...
   Callback = function()
			game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-8, 3, 6)
   end,
})

local TeleportKnightButton = TeleportTab:CreateButton({
   Name = "Teleport To Knight",
   Callback = function()
			game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-236, 4, -239)
   end,
})
